...
int recMaze(int arr[][4], int n,int r,int c,int visited[][4]){
	static int paths=0;
	if (arr[0][0]==0){
...
cout <<	"total possible paths:"<< recMaze(arr,n,0,0,visited);
}
